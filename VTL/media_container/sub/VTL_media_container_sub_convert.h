...
#include <VTL/media_container/sub/VTL_media_container_sub_data.h>   // Для VTL_sub_Format
#include <VTL/media_container/sub/VTL_media_container_sub_style.h>  // Для VTL_sub_StyleParams
...
#endif // _VTL_MEDIA_CONTAINER_SUB_CONVERT_H 