...
#define CONFIGURE_ARGS " '--disable-debug' '--prefix=@@HOMEBREW_CELLAR@@/libpq/18.3' '--with-gssapi' '--with-libcurl' '--with-openssl' '--libdir=@@HOMEBREW_PREFIX@@/opt/libpq/lib' '--includedir=@@HOMEBREW_PREFIX@@/opt/libpq/include' 'CC=clang' 'CXX=clang++' 'PKG_CONFIG_PATH=@@HOMEBREW_PREFIX@@/opt/pkgconf/lib/pkgconfig:@@HOMEBREW_PREFIX@@/opt/icu4c@78/lib/pkgconfig:@@HOMEBREW_PREFIX@@/opt/openssl@3/lib/pkgconfig:@@HOMEBREW_PREFIX@@/opt/krb5/lib/pkgconfig' 'PKG_CONFIG_LIBDIR=/usr/lib/pkgconfig:@@HOMEBREW_LIBRARY@@/Homebrew/os/mac/pkgconfig/14'"
...
#define PG_VERSION_STR "PostgreSQL 18.3 on aarch64-apple-darwin23.6.0, compiled by Apple clang version 16.0.0 (clang-1600.0.26.6), 64-bit"
